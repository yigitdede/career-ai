...
return [
    ...
    'auth' => [
        ...
        'company_required' => 'This account does not have company portal access.',
        'company_membership_required' => 'No active organization membership is linked to this account.',
        'company_organization_required' => 'This account is not linked to this organization workspace.',
        'candidate_required' => 'Company accounts cannot use the candidate panel. Use company login.',
        'no_account' => 'No account yet?',
        'has_account' => 'Already have an account?',
        'panel_kicker' => 'User panel',
        'register_kicker' => 'New career workspace',
        'admin_kicker' => 'Administrator access',
        'company_kicker' => 'Company access',
        ...
        'company_heading' => 'Log in to company workspace',
        'organization_heading' => 'Log in to :organization',
        'organization_logo' => ':organization logo',
        'organization_website' => 'Open organization website',
        ...
        'company_intro' => 'Secure access to your organization and team operations.',
        ...
        'company_boundary' => 'Organization workspace',
        'company_visual_heading' => 'Your team, roles, and hiring foundation.',
        'company_visual_lead' => 'Each organization manages only its own members and future hiring processes.',
        'company_cue_org' => 'Tenant isolation', 'company_cue_org_text' => 'Data opens only inside the active organization context.',
        'company_cue_role' => 'Role-based access', 'company_cue_role_text' => 'Owners, recruiters, and hiring managers have distinct permissions.',
        'company_cue_audit' => 'Auditable changes', 'company_cue_audit_text' => 'Team and permission changes remain controlled.',
        'company_invite_title' => 'Create your company account',
        'company_invite_intro' => ':organization invited :email to its company workspace.',
        'company_invite_submit' => 'Accept invitation', 'company_invite_invalid' => 'This invitation is invalid, expired, or already used.',
        'company_invite_accepted' => 'Your company account is ready. You can now log in.',
