...
class PanelPagesI18nTest extends TestCase
{
  ...
  public static function panelPagesProvider(): array
  {
    return [
      ...
      'skill-passport-tr' => ['/panel/yetenek-pasaportu', 'tr', ['Yetenek Pasaportu', 'Kanıt skoru', 'Kanıt yüklemek için bir yeteneğe tıkla']],
      'skill-passport-en' => ['/panel/yetenek-pasaportu', 'en', ['Skill Passport', 'Evidence score', 'Click a skill to open the upload area below the card.']],
